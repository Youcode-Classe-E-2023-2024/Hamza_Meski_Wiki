...
<div id="home-filtered-index" class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
  ...
  <div class="m-10 flex flex-col items-center mx-auto max-w-screen-lg">
    ...
    <form id="search-form" class="flex bg-blue-500 rounded-md p-2 mb-14 ">   
        ...
        <button type="submit" class="p-2.5 ms-2 text-sm font-medium text-white bg-blue-500 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <div id="search-content" class="grid gap-10 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
      ...
      <div class="bg-white w-full rounded-lg shadow-md flex flex-col transition-all overflow-hidden hover:shadow-2xl">
        <div class="  p-6">
          ...
          <h3 class="mb-4 font-semibold  text-2xl"><a href="" class="transition-all text-blue-700 hover:text-blue-600"><?php echo $data[$i]->title; ?></a></h3>
          <p class="post_content" class="text-sky-700 text-sm mb-0">
